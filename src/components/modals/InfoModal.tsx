  ...
  return (
    <BaseModal title="How to play" isOpen={isOpen} handleClose={handleClose}>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300">
        ...
        cambierà per mostrare quanto ti sei avvicinato alla parola.
      </p>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300">
        La lettera R è nella parola e nel posto giusto.
      </p>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300">
        La lettera S è nella parola ma nel posto sbagliato.
      </p>
